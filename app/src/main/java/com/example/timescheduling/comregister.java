...
public class comregister extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        if (position > 0) {
            ...
            Toast.makeText(parent.getContext(), track, Toast.LENGTH_SHORT).show();
    ...
    private void registerStudent(){
        ...
        final String track =spinner.getSelectedItem().toString();
        ...
        if(TextUtils.isEmpty(shortname) || TextUtils.isEmpty(batch) || TextUtils.isEmpty(track) || TextUtils.isEmpty(email) || TextUtils.isEmpty(username) ||TextUtils.isEmpty(pwd)) {
    ...
    private void registerLecture(){
        ...
        if(TextUtils.isEmpty(shortname) || TextUtils.isEmpty(batch) || TextUtils.isEmpty(email) || TextUtils.isEmpty(username) ||TextUtils.isEmpty(pwd)) {
            Toast.makeText(comregister.this, "some field not filled", Toast.LENGTH_SHORT).show();
        } else {
                    /*progressDialog.setMessage("Registering User....");
                    progressDialog.show();*/
